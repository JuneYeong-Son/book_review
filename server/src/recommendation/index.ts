...
//  - 'popular': 요즘 많이 사는 책 (알라딘 베스트셀러)
export const recommend = (method: RecoMethod, userId?: string): Promise<RecoItem[]> =>
  method === 'popular' ? popularityBasedRecommend() : contentBasedRecommend(userId);
